...
window.addEventListener('load', e => {
    ...
    createApp({
        ...
        sceneURL: params.load || 'ARDemo.glb',
...
function runCode(app, puzzles) {
    ...
    // Add event listener to each circle button
    editButtons.forEach(button => {
        button.addEventListener("click", function() {
            // Reset all buttons to normal state
            editButtons.forEach(btn => {
                 btn.style.backgroundImage = "url('media/" + btn.id + ".png')";
            });
             
            // Set the clicked button's state to active
            this.style.backgroundImage = "url('media/" + this.id + "_clicked.png')";                  
        });
    }); 
    ...
    document
     .getElementById("reset")
     .addEventListener("click", function() {
        //this.style.backgroundImage = "url('media/Move_clicked.png')";
    ...
    // Perform Toggle annotation
    // document
    //     .getElementById("annotation")
    //     .addEventListener("click", function() {
    //         setHTMLElemStyle('display', 'block', ['an_1', 'an_2', 'an_3', 'an_4'], false);
